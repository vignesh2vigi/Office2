...
public class PostalAddressDaoImpl implements PostalAddressDao {
	...
	public PostalAddressModel Addressverify(String clientid, String lead_id,
		...
		System.out.println("leadstatus   "+verifymodel);
		...
		System.out.println("bfghdb"+insertCnt);
	...
	public PostalAddressModel verify(PostalAddressModel address) {
		// TODO Auto-generated method stub
		String clientid=address.getClientid();
		String leadstatus=address.getLead_status();
		String remark=address.getRemark();
		String lead_id=address.getLead_id();
		String reason="";
		PostalAddressModel verifymodel =  new PostalAddressModel();
